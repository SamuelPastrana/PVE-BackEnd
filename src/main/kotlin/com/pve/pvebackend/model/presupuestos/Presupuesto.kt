...
class Presupuesto() {
    ...
    constructor(id: Int, codigoPlan: String, tiempo: String, ahorros: Int, prestamoFamilia: Int, otros: Int, recursosPropios: Int, premios: Int, intercambios: Int, cursos: Int, financiacionCoste: Int) : this() {
        this.id = id
